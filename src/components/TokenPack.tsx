...
const TokenPack: React.FC<Props> = ({ title, subtext, price, original, button }) => (
  <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-4 border border-gray-700">
    ...
    <button className="w-full bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-white font-bold py-2 px-4 rounded-lg transition-all text-sm">
      {button}
    </button>
  </div>
);
